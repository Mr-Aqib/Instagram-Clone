...
<body>
    <div class="container col-lg-7   ">
        <div class="upperdiv my-3  border  mx-auto" style="width: 350px;padding:10px 2.9rem">
            ...
            <form>
                <input type="email" placeholder="Mobile number or email address" class="email form-control rounded-0">

                <input type="text" placeholder="Full Name" class="fullname form-control rounded-0">
                <input type="text" placeholder="Username" class="username form-control rounded-0">
                <input type="password" placeholder="Password" class="password form-control rounded-0">
                <?php
                session_start();
                if (isset($_SESSION['field-notset'])) {
                ?>
                    <p> <?php echo $_SESSION['field-notset'] ?></p>
                <?php
                }
                ...
                <button class="my-3 btn w-100 text-white signupbtn" style="background-color:#4CB5F9;font-size:14px; font-weight:bold">Sign Up</button>
            </form>
        </div>
