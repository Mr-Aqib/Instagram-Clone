    ...
    <div class="container row mx-auto my-5   col-lg-8">
        ...
        <div class="col-lg-5  px-4 right-sec d-flex flex-column gap-3 ">
                ...
                <form action="./signin-data.php" method="POST">
                    <div class="input-div d-flex flex-column gap-2 my-2 ">
                        <input type="text" class="rounded-0 form-control"
                            placeholder="Phone number, usernname or email address" name="siname">

                        <div class="d-flex align-items-center border" style="  background-color: #FAFAFA !important">
                            <input type="password" class="rounded-0 form-control passin" placeholder="Password"
                                name="sipass" style="border:none">
                            <span>
                    ...
                    {$_SESSION['Login-Details-Err']} 
                        ...
                        ?>
                        <button class="text-white text-center  sign-in-btn w-100 my-2 py-1 rounded-2"
                            style="text-decoration:none">Log in</button>
                    </div>
                </form>
            ...
            <div class="middle-div border d-flex align-items-center justify-content-center py-3 ">
                <p class="middle-p align-items-center m-0 d-flex gap-1">Don't have an account? <a
                        href="./signup-form.php" class="text-decoration-none fw-bold middle-a">Sign up</a></p>
            </div>
